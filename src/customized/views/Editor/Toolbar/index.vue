...
import ElementStylePanel from '@/views/Editor/Toolbar/ElementStylePanel/index.vue'
import ElementPositionPanel from '@/views/Editor/Toolbar/ElementPositionPanel.vue'
import ElementAnimationPanel from '@/views/Editor/Toolbar/ElementAnimationPanel.vue'
import SlideDesignPanel from '@/views/Editor/Toolbar/SlideDesignPanel.vue'
import SlideAnimationPanel from '@/views/Editor/Toolbar/SlideAnimationPanel.vue'
import MultiPositionPanel from '@/views/Editor/Toolbar/MultiPositionPanel.vue'
import SymbolPanel from '@/views/Editor/Toolbar/SymbolPanel.vue'
